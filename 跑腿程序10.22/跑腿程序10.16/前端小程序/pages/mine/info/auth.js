  ...
  updateNextButtonEnabled: function (e) {
    ...
    switch (e) {
      case 0:
        ...
        d = n.idCard_code.length >= n.idCard_code_num && n.idCard_name.length > 0;
      ...
      case 1:
        ...
        //d = n.studentCard_schoolId && n.studentCard_faculty.length && n.studentCard_major.length && n.studentCard_enrollmentDate && n.logo;
