...
Page({
    ...
    updateMoneyPayable: function() {
        ...
        console.log('==更新价格updateMoneyPayable==',t);


        var fomatFloat = parseFloat(t);// 先转成parseFloat
        var t = fomatFloat.toFixed(2);// toFixed四舍五入保留2位小数
        console.log('==toFixed==', t);


        e.data.couponValue && (t = a.decimal.subtract(t,e.data.couponValue)), e.setData({
    ...
    onErrandTypeChange: function(e) {
        ...
        console.log('==onErrandTypeChange=nnnnnnnn=');
        console.log(n);
